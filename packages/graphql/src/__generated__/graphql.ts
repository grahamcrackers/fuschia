...
export type CreateEmptyCartMutationMutationVariables = Exact<{ [key: string]: never }>;

export type CreateEmptyCartMutationMutation = { createEmptyCart: string | null };
...
export type GetCategorySortMethodsQueryVariables = Exact<{
    uid: Scalars["String"]["input"];
}>;

export type GetCategorySortMethodsQuery = {
    products: {
        sort_fields: {
            default: string | null;
            options: Array<{ label: string | null; value: string | null } | null> | null;
        } | null;
    } | null;
};

export type GetMegaMenuCategoriesQueryVariables = Exact<{ [key: string]: never }>;

export type GetMegaMenuCategoriesQuery = {
    categories: {
        items: Array<{
            uid: string;
            name: string | null;
...
export type GetCmsBlocksQuery = {
    cmsBlocks: {
        items: Array<{ identifier: string | null; title: string | null; content: string | null } | null> | null;
    } | null;
};

export type GetGurrencyQueryVariables = Exact<{ [key: string]: never }>;

export type GetGurrencyQuery = {
    currency: {
        default_display_currency_code: string | null;
        available_currency_codes: Array<string | null> | null;
    } | null;
};

export type GetProductDetailForProductPageQueryVariables = Exact<{
    urlKey: Scalars["String"]["input"];
}>;

export type GetProductDetailForProductPageQuery = {
    products: {
        items: Array<
            | ({ id: number | null; uid: string } & {
                  " $fragmentRefs"?: {
                      ProductDetailsFragment_BundleProduct_Fragment: ProductDetailsFragment_BundleProduct_Fragment;
                  };
              })
            | ({ id: number | null; uid: string } & {
                  " $fragmentRefs"?: {
                      ProductDetailsFragment_ConfigurableProduct_Fragment: ProductDetailsFragment_ConfigurableProduct_Fragment;
                  };
              })
            | ({ id: number | null; uid: string } & {
                  " $fragmentRefs"?: {
                      ProductDetailsFragment_DownloadableProduct_Fragment: ProductDetailsFragment_DownloadableProduct_Fragment;
                  };
              })
            | ({ id: number | null; uid: string } & {
                  " $fragmentRefs"?: {
                      ProductDetailsFragment_GroupedProduct_Fragment: ProductDetailsFragment_GroupedProduct_Fragment;
                  };
              })
            | ({ id: number | null; uid: string } & {
                  " $fragmentRefs"?: {
                      ProductDetailsFragment_SimpleProduct_Fragment: ProductDetailsFragment_SimpleProduct_Fragment;
                  };
              })
            | ({ id: number | null; uid: string } & {
                  " $fragmentRefs"?: {
                      ProductDetailsFragment_VirtualProduct_Fragment: ProductDetailsFragment_VirtualProduct_Fragment;
                  };
              })
            | null
        > | null;
...
type ProductDetailsFragment_BundleProduct_Fragment = {
    ...
    sku: string | null;
    name: string | null;
    categories: Array<{ uid: string; breadcrumbs: Array<{ category_uid: string } | null> | null } | null> | null;
    price: { regularPrice: { amount: { currency: CurrencyEnum | null; value: number | null } | null } | null } | null;
    small_image: { url: string | null } | null;
    description: { html: string } | null;
    short_description: { html: string } | null;
    media_gallery: Array<
        | { label: string | null; position: number | null; disabled: boolean | null; url: string | null }
        | { label: string | null; position: number | null; disabled: boolean | null; url: string | null }
        | null
    > | null;
} & { " $fragmentName"?: "ProductDetailsFragment_BundleProduct_Fragment" };

type ProductDetailsFragment_ConfigurableProduct_Fragment = {
    ...
    configurable_options: Array<{
        ...
        values: Array<{
            ...
            swatch_data:
                | { value: string | null }
                | { thumbnail: string | null; value: string | null }
                | { value: string | null }
                | null;
        } | null> | null;
    } | null> | null;
    ...
    media_gallery: Array<
        ...
        | null
    > | null;
} & { " $fragmentName"?: "ProductDetailsFragment_ConfigurableProduct_Fragment" };

type ProductDetailsFragment_DownloadableProduct_Fragment = {
    ...
    media_gallery: Array<
        ...
        | null
    > | null;
} & { " $fragmentName"?: "ProductDetailsFragment_DownloadableProduct_Fragment" };

type ProductDetailsFragment_GroupedProduct_Fragment = {
    ...
    media_gallery: Array<
        ...
        | null
    > | null;
} & { " $fragmentName"?: "ProductDetailsFragment_GroupedProduct_Fragment" };

type ProductDetailsFragment_SimpleProduct_Fragment = {
    ...
    media_gallery: Array<
        ...
        | null
    > | null;
} & { " $fragmentName"?: "ProductDetailsFragment_SimpleProduct_Fragment" };

type ProductDetailsFragment_VirtualProduct_Fragment = {
    ...
    media_gallery: Array<
        ...
        | null
    > | null;
} & { " $fragmentName"?: "ProductDetailsFragment_VirtualProduct_Fragment" };

export type ProductDetailsFragmentFragment =
    | ProductDetailsFragment_BundleProduct_Fragment
    | ProductDetailsFragment_ConfigurableProduct_Fragment
    | ProductDetailsFragment_DownloadableProduct_Fragment
    | ProductDetailsFragment_GroupedProduct_Fragment
...
export type ProductsFragmentFragment = {
    ...
    items: Array<
        | {
              ...
              price_range: {
                  maximum_price: {
                      ...
                      discount: { amount_off: number | null } | null;
                  } | null;
              };
              small_image: { label: string | null; url: string | null } | null;
          }
        | {
              __typename: "ConfigurableProduct";
              uid: string;
        ...
        | null
    > | null;
    page_info: { total_pages: number | null } | null;
} & { " $fragmentName"?: "ProductsFragmentFragment" };

export type GetProductsByCategoryDocumentQueryVariables = Exact<{
    id: Scalars["String"]["input"];
...
export type GetProductsByCategoryDocumentQuery = {
    categories: {
        items: Array<{ " $fragmentRefs"?: { CategoryFragmentFragment: CategoryFragmentFragment } } | null> | null;
    } | null;
    products: { " $fragmentRefs"?: { ProductsFragmentFragment: ProductsFragmentFragment } } | null;
};
...
export type GetRouteInfoQueryVariables = Exact<{
    url: Scalars["String"]["input"];
}>;

export type GetRouteInfoQuery = {
    route:
        | { __typename: "BundleProduct"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | { __typename: "CategoryTree"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | { identifier: string | null; type: UrlRewriteEntityTypeEnum | null }
        | { __typename: "ConfigurableProduct"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | { __typename: "DownloadableProduct"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | { __typename: "GroupedProduct"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | { __typename: "SimpleProduct"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | { __typename: "VirtualProduct"; uid: string; type: UrlRewriteEntityTypeEnum | null }
        | null;
};
...
export type GetAvailableStoresQueryVariables = Exact<{
    useCurrentGroup?: InputMaybe<Scalars["Boolean"]["input"]>;
}>;
...
export type GetPageSizeQuery = {
    storeConfig: { grid_per_page: number | null; grid_per_page_values: string | null } | null;
};

export const ProductDetailsFragmentFragmentDoc = {
    kind: "Document",
    definitions: [
        {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "uid" } },
                                {
                                    ...
                                    selectionSet: {
                                        kind: "SelectionSet",
                                        selections: [{ kind: "Field", name: { kind: "Name", value: "category_uid" } }],
                                    },
                                },
                            ],
                        },
...
} as unknown as DocumentNode<ProductDetailsFragmentFragment, unknown>;
    ...
    definitions: [
        {
            ...
            selectionSet: {
                ...
                selections: [
                    { kind: "Field", name: { kind: "Name", value: "uid" } },
                    { kind: "Field", name: { kind: "Name", value: "meta_title" } },
                    { kind: "Field", name: { kind: "Name", value: "meta_keywords" } },
                    { kind: "Field", name: { kind: "Name", value: "meta_description" } },
                ],
            },
        },
...
} as unknown as DocumentNode<ProductsFragmentFragment, unknown>;
export const CreateEmptyCartMutationDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "CreateEmptyCartMutation" },
            selectionSet: {
                kind: "SelectionSet",
...
} as unknown as DocumentNode<CreateEmptyCartMutationMutation, CreateEmptyCartMutationMutationVariables>;
export const GetBreadcrumbsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetBreadcrumbs" },
            variableDefinitions: [
                {
                                        ...
                                        selections: [
                                            {
                                                ...
                                                selectionSet: {
                                                    ...
                                                    selections: [
                                                        ...
                                                        {
                                                            kind: "Field",
                                                            name: { kind: "Name", value: "category_level" },
                                                        },
                                                        {
                                                            kind: "Field",
...
} as unknown as DocumentNode<GetBreadcrumbsQuery, GetBreadcrumbsQueryVariables>;
export const GetCategorySortMethodsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetCategorySortMethods" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "uid" } },
...
} as unknown as DocumentNode<GetCategorySortMethodsQuery, GetCategorySortMethodsQueryVariables>;
export const GetMegaMenuCategoriesDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetMegaMenuCategories" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<GetMegaMenuCategoriesQuery, GetMegaMenuCategoriesQueryVariables>;
export const GetCmsBlocksDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetCmsBlocks" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "identifiers" } },
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "cmsBlocks" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "identifiers" },
                                value: { kind: "Variable", name: { kind: "Name", value: "identifiers" } },
                            },
                        ],
                        selectionSet: {
                            kind: "SelectionSet",
...
} as unknown as DocumentNode<GetCmsBlocksQuery, GetCmsBlocksQueryVariables>;
export const GetGurrencyDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetGurrency" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "available_currency_codes" } },
                            ],
                        },
                    },
                ],
...
} as unknown as DocumentNode<GetGurrencyQuery, GetGurrencyQueryVariables>;
export const GetProductDetailForProductPageDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getProductDetailForProductPage" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetProductDetailForProductPageQuery, GetProductDetailForProductPageQueryVariables>;
export const GetProductsByCategoryDocumentDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetProductsByCategoryDocument" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
            ...
            selectionSet: {
                ...
                selections: [
                    ...
                    },
                    {
                        ...
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [{ kind: "FragmentSpread", name: { kind: "Name", value: "ProductsFragment" } }],
                        },
                    },
                ],
            },
...
} as unknown as DocumentNode<GetProductsByCategoryDocumentQuery, GetProductsByCategoryDocumentQueryVariables>;
export const GetProductFiltersByCategoryDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            ...
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "categoryIdFilter" } },
                    type: {
                        kind: "NonNullType",
                                    ...
                                    fields: [
                                        {
                                            ...
                                            value: {
                                                kind: "Variable",
                                                name: { kind: "Name", value: "categoryIdFilter" },
                                            },
                                        },
                                    ],
                                },
...
} as unknown as DocumentNode<GetProductFiltersByCategoryQuery, GetProductFiltersByCategoryQueryVariables>;
export const GetRouteInfoDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetRouteInfo" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetRouteInfoQuery, GetRouteInfoQueryVariables>;
...
export const GetAvailableStoresDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetAvailableStores" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "useCurrentGroup" } },
                ...
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "useCurrentGroup" },
                                value: { kind: "Variable", name: { kind: "Name", value: "useCurrentGroup" } },
                            },
                        ],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "secure_base_media_url" } },
                                { kind: "Field", name: { kind: "Name", value: "store_code" } },
                                { kind: "Field", name: { kind: "Name", value: "store_group_code" } },
                                { kind: "Field", name: { kind: "Name", value: "store_group_name" } },
                                { kind: "Field", name: { kind: "Name", value: "store_name" } },
                                { kind: "Field", name: { kind: "Name", value: "store_sort_order" } },
                            ],
                        },
                    },
                ],
...
} as unknown as DocumentNode<GetAvailableStoresQuery, GetAvailableStoresQueryVariables>;
export const GetPageSizeDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetPageSize" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "grid_per_page_values" } },
                            ],
                        },
                    },
                ],
...
} as unknown as DocumentNode<GetPageSizeQuery, GetPageSizeQueryVariables>;
